...
public interface TypeVariableBuilder {
    ...
    default TypeVariable type(String label) {
        return asTypeWith(new TypeConstraint.Label(label));
    }

    default TypeVariable type(String scope, String label) {
        return asTypeWith(new TypeConstraint.Label(scope, label));
    }

    default TypeVariable isAbstract() {
        return asTypeWith(new TypeConstraint.Abstract());
    }
    ...
    default TypeVariable sub(String typeLabel) {
        return asTypeWith(new TypeConstraint.Sub(typeLabel, false));
    }

    default TypeVariable sub(String typeScope, String typeLabel) {
        return asTypeWith(new TypeConstraint.Sub(typeScope, typeLabel, false));
    }

    default TypeVariable sub(UnboundVariable typeVar) {
        return asTypeWith(new TypeConstraint.Sub(typeVar, false));
    }
