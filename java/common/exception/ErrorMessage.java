...
public class ErrorMessage extends grakn.common.exception.ErrorMessage {
    ...
    public static final ErrorMessage VARIABLE_OUT_OF_SCOPE_MATCH =
            new ErrorMessage(10, "The variable '%s' is out of scope of the match query.");
    public static final ErrorMessage VARIABLE_OUT_OF_SCOPE_DELETE =
            new ErrorMessage(11, "The deleted variable '%s' is out of scope of the match query.");
    public static final ErrorMessage NO_VARIABLE_IN_SCOPE_INSERT =
            new ErrorMessage(12, "None of the variables in 'insert' ('%s') is within scope of 'match' ('%s')");
    public static final ErrorMessage VARIABLE_NOT_NAMED =
            new ErrorMessage(13, "The variable '%s' is not named and cannot be used as a filter for match query.");
    public static final ErrorMessage INVALID_VARIABLE_NAME =
            new ErrorMessage(14, "The variable name '%s' is invalid; variables must match the following regular expression: '%s'.");
    public static final ErrorMessage ILLEGAL_CONSTRAINT_REPETITION =
            new ErrorMessage(15, "The variable '%s' contains illegally repeating constraints: '%s' and '%s'.");
    public static final ErrorMessage MISSING_CONSTRAINT_RELATION_PLAYER =
            new ErrorMessage(16, "A relation variable has not been provided with role players.");
    public static final ErrorMessage MISSING_CONSTRAINT_VALUE =
            new ErrorMessage(17, "A value constraint has not been provided with a variable or literal value.");
    public static final ErrorMessage MISSING_CONSTRAINT_PREDICATE =
            new ErrorMessage(18, "A value constraint has not been provided with a predicate.");
    public static final ErrorMessage INVALID_CONSTRAINT_DATETIME_PRECISION =
            new ErrorMessage(19, "Attempted to assign DateTime value of '%s' which is more precise than 1 millisecond.");
    public static final ErrorMessage INVALID_DEFINE_QUERY_VARIABLE =
            new ErrorMessage(20, "Invalid define/undefine query. User defined variables are not accepted in define/undefine query.");
    public static final ErrorMessage INVALID_RULE_WHEN_MISSING_PATTERNS =
            new ErrorMessage(21, "Rule '%s' 'when' has not been provided with any patterns.");
    public static final ErrorMessage INVALID_RULE_WHEN_NESTED_NEGATION =
            new ErrorMessage(22, "Rule '%s' 'when' contains a nested negation.");
    public static final ErrorMessage INVALID_RULE_WHEN_CONTAINS_DISJUNCTION =
            new ErrorMessage(23, "Rule '%s' 'when' contains a disjunction.");
    public static final ErrorMessage INVALID_RULE_THEN =
            new ErrorMessage(24, "Rule '%s' 'then' '%s': must be exactly one attribute ownership, or exactly one relation.");
    public static final ErrorMessage INVALID_RULE_THEN_HAS =
            new ErrorMessage(25, "Rule '%s' 'then' '%s': is trying to assign both an attribute type and a variable attribute value.");
    public static final ErrorMessage INVALID_RULE_THEN_VARIABLES =
            new ErrorMessage(26, "Rule '%s' 'then' variables must be present in rule 'when'.");
    public static final ErrorMessage REDUNDANT_NESTED_NEGATION =
            new ErrorMessage(27, "Invalid query containing redundant nested negations.");
    public static final ErrorMessage MISSING_COMPUTE_CONDITION =
            new ErrorMessage(28, "Missing condition(s) for 'compute '%s''. The required condition(s) are: '%s'.");
    public static final ErrorMessage INVALID_COMPUTE_METHOD_ALGORITHM =
            new ErrorMessage(29, "Invalid algorithm for 'compute '%s''. The accepted algorithm(s) are: '%s'.");
    public static final ErrorMessage INVALID_COMPUTE_ARGUMENT =
            new ErrorMessage(30, "Invalid argument(s) 'compute %s using %s'. The accepted argument(s) are: '%s'.");
    public static final ErrorMessage INVALID_SORTING_ORDER =
            new ErrorMessage(31, "Invalid sorting order. Valid options: '%s' or '%s'.");
    public static final ErrorMessage INVALID_COUNT_VARIABLE_ARGUMENT =
            new ErrorMessage(32, "Aggregate COUNT does not accept a Variable.");
    public static final ErrorMessage ILLEGAL_GRAMMAR =
            new ErrorMessage(33, "Illegal grammar!");
