...
error_messages! {
   ...
   INVALID_RULE_THEN_ROLES = 33: "Rule '{}' 'then' '{}' must specify all role types explicitly or by using a variable.",
   REDUNDANT_NESTED_NEGATION = 34: "Invalid query containing redundant nested negations.",
   VARIABLE_NOT_SORTED = 35: "Variable '{}' does not exist in the sorting clause.",
   INVALID_SORTING_ORDER = 36: "Invalid sorting order '{}'. Valid options: '{}' or '{}'.",
   INVALID_COUNT_VARIABLE_ARGUMENT = 37: "Aggregate COUNT does not accept a Variable.",
   ILLEGAL_GRAMMAR = 38: "Illegal grammar: '{}'",
   ILLEGAL_CHAR_IN_LABEL = 39: "'{}' is not a valid Type label. Type labels must start with a letter, and may contain only letters, numbers, '-' and '_'.",
}
